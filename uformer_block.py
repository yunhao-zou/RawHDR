...
if __name__ == "__main__":
    ...
    model_restoration = Uformer(img_size=input_size, in_chans=4, dd_in=4, embed_dim=16, depths=depths,
                 win_size=8, mlp_ratio=4., token_projection='linear', token_mlp='fastleff', modulator=True, shift_flag=False)
    # print(model_restoration)
    
    model_restoration = model_restoration.cuda()
    data = torch.cuda.FloatTensor(1, 4, 512, 512).fill_(1)
    out = model_restoration(data)
